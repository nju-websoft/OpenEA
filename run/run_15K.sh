...
training_data=('DBP_en_DBP_de_15K_V1' 'DBP_en_DBP_de_15K_V2' 'DBP_en_DBP_fr_15K_V1' 'DBP_en_DBP_fr_15K_V2'
                 'DBP_en_WD_en_15K_V1' 'DBP_en_WD_en_15K_V2' 'DBP_en_YG_en_15K_V1' 'DBP_en_YG_en_15K_V2')
if [[ ${data} == "dev1" ]]; then
    training_data=('DBP_en_DBP_de_15K_V1')
elif [[ ${data} == "dev2" ]]; then
    training_data=('DBP_en_DBP_de_15K_V2')
elif [[ ${data} == "de" ]]; then
    training_data=('DBP_en_DBP_de_15K_V1' 'DBP_en_DBP_de_15K_V2')

elif [[ ${data} == "frv1" ]]; then
    training_data=('DBP_en_DBP_fr_15K_V1')
elif [[ ${data} == "frv2" ]]; then
    training_data=('DBP_en_DBP_fr_15K_V2')
elif [[ ${data} == "fr" ]]; then
    training_data=('DBP_en_DBP_fr_15K_V1' 'DBP_en_DBP_fr_15K_V2')

elif [[ ${data} == "wdv1" ]]; then
    training_data=('DBP_en_WD_en_15K_V1')
elif [[ ${data} == "wdv2" ]]; then
    training_data=('DBP_en_WD_en_15K_V2')
elif [[ ${data} == "wd" ]]; then
    training_data=('DBP_en_WD_en_15K_V1' 'DBP_en_WD_en_15K_V2')

elif [[ ${data} == "ygv1" ]]; then
    training_data=('DBP_en_YG_en_15K_V1')
elif [[ ${data} == "ygv2" ]]; then
    training_data=('DBP_en_YG_en_15K_V2')
elif [[ ${data} == "yg" ]]; then
    training_data=('DBP_en_YG_en_15K_V1' 'DBP_en_YG_en_15K_V2')
fi
